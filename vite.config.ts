  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        injectedScript: resolve(pagesDir, 'content', 'ui', 'injected.ts'),
        injector: resolve(pagesDir, 'content', 'ui', 'injector.ts'),
        contentUI: resolve(pagesDir, 'content', 'ui', 'index.ts'),
        background: resolve(pagesDir, 'background', 'index.ts'),
        contentStyle: resolve(pagesDir, 'content', 'style.scss'),
        popup: resolve(pagesDir, 'popup', 'index.html'),
        contentDynamicConfig: resolve(pagesDir, 'content', 'dynamic', 'index.ts'),
