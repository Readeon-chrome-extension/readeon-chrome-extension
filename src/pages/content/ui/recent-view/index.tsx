    ...
    if (isExtensionEnable) {
      const warningEle = ` <div
                style="
                  ...
                  font-size:14px;
                ">
                Readeon does not support "Readeon View” for this component.<br /> If “Full Screen” button is not working as intended, then scroll all the way down the home page then back up and try using the button again.
              </div>`;
